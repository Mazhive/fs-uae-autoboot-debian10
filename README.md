...
##				it is possible to use the older amiga OS version			                  ##
...
##																                                                ##
##		SOME KNOWLEDGE OF LINUX IS ADVISED TO UNDERSTAND THE 		                    ##
##		WAY IT WORKS											                                          ##
##																                                                ##
...
%you'l be presented to install debian use the advanced option
%use the automated preconfiguration 
